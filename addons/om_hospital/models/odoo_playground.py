...
class TechnicalPlayground(models.Model):
    ...
    # - self.env.su: Return whether the current environment is in superuser mode.
    ...
    # - self.env.lang: Return the current language code (e.g. 'en_US')
    """
